...
<body>
    <div class="container">
        ...
        <h1>SALES - <span id="brn-name"></span><span class="color"></span>Allready Called!</h1>
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn action-btn" data-action="bill_value">Bill value</button>
            <button type="button" class="btn action-btn" data-action="bday">Birthday</button>
            <button type="button" class="btn action-btn" data-action="visit_cnt">Visit count</button>
            <button type="button" class="btn action-btn" data-action="lst_visit">Last visit</button>
            <!-- <button type="button" class="btn action-btn" id="leadBtn">Lead</button> -->

            <!-- Lead Filter Options -->
            <div id="leadFilters" class="lead-filter-options" style="display: none;">
                <div class="filter_btns">
                    <button type="button" class="btn filter-btn active" data-lead-type="">All Leads</button>
                    <button type="button" class="btn filter-btn" data-lead-type="S">Sales</button>
                    <button type="button" class="btn filter-btn" data-lead-type="C">Chit</button>
                    <button type="button" class="btn filter-btn" data-lead-type="V">Visit</button>
                </div>
            </div>
        </div>

        <!-- Add after the .btn-group and before #data-container -->
